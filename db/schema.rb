...
ActiveRecord::Schema.define(version: 2020_03_05_202207) do
  ...
  create_table "banners", force: :cascade do |t|
    ...
    t.bigint "banner_category_id", null: false
    t.text "description"
    t.datetime "start_at"
    ...
    t.index ["bannerable_type", "bannerable_id"], name: "index_banners_on_bannerable_type_and_bannerable_id"
  end
  ...
  create_table "editories", force: :cascade do |t|
    t.string "name"
    t.string "slug"
    t.integer "status", default: 0
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["deleted_at"], name: "index_editories_on_deleted_at"
  end
